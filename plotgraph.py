...
fig = plt.figure('Results for {}'.format(filename), figsize=(20, 14))

plt.subplot(2, 1, 1)
plt.plot(DIFF_FILT, color='red', linewidth=4, label='Filtered')
plt.plot(DIFF_UNFILT, color='orange', linewidth=2, label='Unfiltered')
...
plt.subplot(2, 1, 2)
plt.plot(ROT_FILT, color='blue', linewidth=4, label='Filtered')
plt.plot(ROT_UNFILT, color='green', linewidth=2, label='Unfiltered')
